...
@TestPropertySource(properties = {
        "spring.datasource.url=jdbc:mysql://localhost:3306/testingDB",
        "spring.datasource.username=root",
        "spring.datasource.password=Punarvika6722",
        // Add other necessary properties like driver class name, ddl-auto, etc.
})
public class EmployeeRepositoryIntegrationTest {
    ...
    public void givenEmployeeObject_whenSave_thenReturnSavedEmployee() {
        ...
        System.out.println("saved Employee id is:"+savedEmployee.getId());
    ...
    public void givenEmployeeObject_whenFindByEmail_thenReturnEmployeeObject() {
        ...
        //When - The behaviour that we are going to test
        Employee employee = employeeRepository.findByEmail(employee1.getEmail()).orElse(null);

        //then - verify the output
        assertThat(employee).isNotNull();
        assertThat(employee.getEmail()).isEqualTo("pradeep@gmail.com");
    }
    ...
    public void givenEmployeeObject_whenUpdateEmployee_thenReturnUpdatedEmployee() {
        ...
        //When - The behaviour that we are going to test
        Employee employeeToUpdate = employeeRepository.findById(employee1.getId()).get();
    ...
    public void givenFirstNameAndLastName_whenFindByNativeSQL_thenReturnEmployeeObject_named() {
        ...
        employeeRepository.save(employee1);
        //When - The behaviour that we are going to test
        Employee savedEmployee = employeeRepository.findByNativeSQLUsingNamedParam(employee1.getFirstName(), employee1.getLastName());
